...
{
private:
    static Model *instance; ///< single instance (static)
...
public:
    static Model &getInstance(); ///< Static method to get the single instance
    ...
    /**
     * @brief Model class Factory Method
     */
     ...
     */
    System &createSystem(string name, float value);
