...
// ! É possível implementar os testes unitários com factory method, mantendo acesso aos membros dos objetos?
// void unit_flow::unit_flow_constructor(void)
// {
//     Model& model = Model::createModel();
//     Flow &flow1 = model.createFlow<Exponencial>("Test flow1");
//     Flow &flow2 = model.createFlow<Logistic>("Test flow2");
