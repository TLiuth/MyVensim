 ...
 * @brief Implementation of functional test functions.
 * @date 2025-01-27
 * @version 1.1
...
/**
 * @brief Functional test for exponencial flow
 */
...
/**
 * @brief Functional test for a model with multiple flows and systems
 */
